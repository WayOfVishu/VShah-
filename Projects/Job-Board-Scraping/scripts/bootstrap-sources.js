...
// Shared with the dashboard on purpose (PRD req. 17) — see discover.js.
...
async function main() {
  if (!existsSync(DB_PATH)) {
    console.error(`jobs.db not found at ${DB_PATH} — expected Job-Tracking-Dash as a sibling directory with a few logged applications, or set JOBS_DB_PATH.`);
    process.exit(1);
  }
